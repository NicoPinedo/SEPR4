...
Code coverage (development): [![Code Coverage](https://img.shields.io/codecov/c/github/NicoPinedo/SEPR4/master.svg)](https://codecov.io/github/NicoPinedo/SEPR4?branch=master)

...
Code coverage (development): [![Code Coverage](https://img.shields.io/codecov/c/github/NicoPinedo/SEPR4/codeCoverage.svg)](https://codecov.io/github/NicoPinedo/SEPR4?branch=codeCoverage)

...
public class LabelledElement extends Table {
     ...
     */
    private LabelledElement(String labelText, TTFont labelFont, Color labelColor, boolean labelRight, Actor actor, float labelSpacing, float actorSpacing) {
        super();
        //Set up table format
